...
import { facebookRedirect } from "../controllers/Facebook.controller.js";
import passport from "../middlewares/facebook.js";
...
router.get("/auth/facebook/callback", passport.authenticate("auth-facebook", { failureRedirect: "/login" }), facebookRedirect);
router.get("/auth/facebook",passport.authenticate("auth-facebook", { scope: ["public_profile"] }));
//Rutas get Fin
